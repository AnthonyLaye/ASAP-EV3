...
import ca.mcgill.ecse211.finalproject.DriveDetect.Color;
...
public class Lab5 {
		...
		static SensorModes usSensorCol = new EV3UltrasonicSensor(LocalEV3.get().getPort("S1")); // usSensor is the instance
		static SampleProvider usDistanceCol = usSensorCol.getMode("Distance"); // usDistance provides samples from
		// this instance
		static float[] usDataCol = new float[usDistanceCol.sampleSize()]; // usData is the buffer in which data are
		...
		public static final double TRACK = 11.3;
		  ...
		  public static void main(String[] args) throws OdometerExceptions {
			   ...
			   // final TestDrive testDrive = new TestDrive(Navigator);
			    ...
			    final DriveDetect driveDetect = new DriveDetect(leftMotor, rightMotor, Navigator, LS);
			    ...
			    (new Thread() {
			        public void run() {
			          ...
			          driveDetect.search(2, 2, 4, 5, Color.GREEN);
			          //driveDetect.pollColour();
