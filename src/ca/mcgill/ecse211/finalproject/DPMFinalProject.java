		   ...
		   // else {	//Corner = 3 or the game parameters were wrong...
		    ...
		    (new Thread() {
		        public void run() {
		          ...
		          tunnelFollower.traverseTunnel(tnURX, tnURY, tnLLX, tnLLY, islandURX, islandURY, islandLLX, islandLLY,urX, urY, llX, llY, tnURX, tnURY, tnLLX, tnLLY); // Travel opposite way through tunnel
