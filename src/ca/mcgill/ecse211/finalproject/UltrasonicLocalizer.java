...
private void fallingEdgeRoutine() {
	  // TODO Auto-generated method stub
		...
		/*
			...
			int dx = Navigator.readUSDistance();
			rotateTheRobot(false, 10, false);
			stopMotor();
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
			...
			int correctDx1 = Navigator.readUSDistance();
			rotateTheRobot(true, 20, false);
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
				// TODO Auto-generated catch block
			...
			int correctDx2 = Navigator.readUSDistance();
			rotateTheRobot(false, 10, false);
			...
			else if(correctDx2 - correctDx1 > 1)
			{
				...
				correctLeft = 0;
			rotateTheRobot(true, 90 - correctLeft, false);
			
			//detect the distance from back wall
			rotateTheRobot(true, 180, false);
			stopMotor();
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
			...
			int dy = Navigator.readUSDistance();
			rotateTheRobot(true, 10, false);
			stopMotor();
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
			...
			int correctDy1 = Navigator.readUSDistance();
			rotateTheRobot(false, 20, false);
			stopMotor();
			try {
				Thread.sleep(2000);
			} catch (InterruptedException e) {
			...
			else if(correctDy2 - correctDy1 > 1)
			{
				...
				correctBack = 0;
			rotateTheRobot(false, 180 - correctBack, false);
			//move the robot
			advanceRobot(moveFromBacktWall, false);
			rotateTheRobot(true, 90, false);
			advanceRobot(moveFromLeftWall, false);
			rotateTheRobot(false, 90, false);*/
  }
